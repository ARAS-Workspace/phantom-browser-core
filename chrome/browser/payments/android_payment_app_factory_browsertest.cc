...
class AndroidPaymentAppFactoryTest
 ...
 public:
  AndroidPaymentAppFactoryTest() {
    ...
    // AndroidAppCommunicationStub is used and AndroidPaymentAppFactory
    // discovers zero Android payment apps. Tests that request both Play
    // Billing and a Web payment method (such as
