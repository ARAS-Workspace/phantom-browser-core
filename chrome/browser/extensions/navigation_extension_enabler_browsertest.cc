...
IN_PROC_BROWSER_TEST_F(DisableExtensionBrowserTest,
  ...
  // TODO(crbug.com/40192071): remove the exception for Mac below once
  // renderer-process shutdown delay causing `extension_site_instance` to be
  // reused is addressed (see
