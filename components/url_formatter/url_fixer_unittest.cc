...
constexpr auto kSegmentCases = std::to_array<SegmentCase>({
    ...
    {
        .input = "phantom://host/path?query#ref",
        .result = "phantom",
        .scheme = url::Component(0, 7),
        .username = url::Component(),
        .password = url::Component(),
        .host = url::Component(10, 4),
        .port = url::Component(),
        .path = url::Component(14, 5),
        .query = url::Component(20, 5),
        .ref = url::Component(26, 3),
    },
    {
...
struct FixupCase {
  ...
  const std::string output;
    ...
    {"phantom:", "chrome://version/"},
    {"phantom:flags", "chrome://flags/"},
    {"phantom://settings/help", "chrome://settings/help"},
    {"phantom://usr:pwd@hst/pth?qry#ref", "chrome://hst/pth?qry#ref"},
    {"chrome://usr:pwd@hst/pth?qry#ref", "chrome://hst/pth?qry#ref"},
